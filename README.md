...
- `/admin/products`: dashboard para crear/editar/eliminar productos con UI reactiva.
...
- Placeholder por defecto (`/img/perfume-placeholder.svg`) y referencias desde la API; si `image` está vacío se usa el placeholder.
...
- Microanimaciones (hover parallax, toasts con acciones) y tests e2e.
